...
public class PlaceAutocompleteAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
     ...
     */
    public PlaceAutocompleteAdapter(GeoDataClient geoDataClient,
                                    LatLngBounds bounds, AutocompleteFilter filter) {
        super(getAppContext(), android.R.layout.simple_expandable_list_item_2, android.R.id.text1);
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (item!=null) {
            textViewOne.setText(item.getPrimaryText(STYLE_BOLD));
            textViewOne.setTextColor(getAppContext().getColor(R.color.colorWhite));
            textViewTwo.setText(item.getSecondaryText(STYLE_BOLD));
            textViewTwo.setTextColor(getAppContext().getColor(R.color.colorWhite));
        }
